...
class DtaDevLinuxTPer_SCSI: public DtaDevLinuxTPer {
public:
...
//     */
//    DtaDevLinuxTPer_SAT(io_registry_entry_t _driverService, io_connect_t _connect){
//        init(_driverService, _connect);
//    };
    using DtaDevLinuxTPer::DtaDevLinuxTPer;
