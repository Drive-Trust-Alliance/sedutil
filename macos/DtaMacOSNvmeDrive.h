 ...
 * device
 */
class DtaMacOSNvmeDrive: public DtaNvmeDrive {
public:
    using DtaNvmeDrive::DtaNvmeDrive;

    /** Factory function to look at the devref and create an instance of DtaMacOSNvmeDrive
     ...
     */
    static DtaMacOSNvmeDrive * getDtaMacOSNvmeDrive(const char * devref,
                                                    DTA_DEVICE_INFO & disk_info)
    {
        return dynamic_cast<DtaMacOSNvmeDrive *>(getDtaNvmeDrive(devref,disk_info));
    }
};
