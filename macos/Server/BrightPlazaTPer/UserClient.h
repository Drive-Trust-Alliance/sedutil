...
protected:
    ...
    // TPer methods
    static IOReturn sUserClientSCSIPassthrough(UserClientClass* target,
                                               void* reference,
                                               IOExternalMethodArguments* arguments);
    IOReturn userClientSCSIPassthrough(SCSICommandDescriptorBlock cdb,
                                       void * inBuffer,
                                       uint64_t inBufferSize);

    
    static IOReturn sUserClientUpdateLockingPropertiesInIORegistry(UserClientClass* target,
                                                                   void* reference,
                                                                   IOExternalMethodArguments* arguments);
    IOReturn UserClientUpdateLockingPropertiesInIORegistry(void);
