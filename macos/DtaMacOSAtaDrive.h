...
/** MacOS specific implementation of DtaDev.
 * Uses the ATA ioctls to send commands to the
 * device
 */
class DtaMacOSAtaDrive: public DtaAtaDrive {
public:
    using DtaAtaDrive::DtaAtaDrive;

    /** Factory function to look at the devref and create an instance of DtaMacOSAtaDrive
     ...
     */
    static DtaDrive * getDtaMacOSAtaDrive(const char * devref,
