...
uint8NOCODE(auditWrite, char * password,char * idstr, char * userid)
uint8NOCODE(auditRead, char * password, char * userid)
uint8NOCODE(auditErase, char * password, char * userid)
uint8NOCODE(getmfgstate)
uint8NOCODE(DataStoreWrite, char * password, char * userid, char * filename, uint8_t dsnum, uint32_t startpos, uint32_t len)
uint8NOCODE(DataStoreRead, char * password, char * userid, char * filename, uint8_t dsnum, uint32_t startpos, uint32_t len)
