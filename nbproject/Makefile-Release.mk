...
${OBJECTDIR}/msed/Discovery0.o: msed/Discovery0.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -s -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/Discovery0.o msed/Discovery0.cpp
...
${OBJECTDIR}/msed/linux/Device_linux.o: msed/linux/Device_linux.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -s -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/linux/Device_linux.o msed/linux/Device_linux.cpp

${OBJECTDIR}/msed/linux/DiskList_linux.o: msed/linux/DiskList_linux.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed/linux
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -s -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/linux/DiskList_linux.o msed/linux/DiskList_linux.cpp
