...
${OBJECTDIR}/msed/Device_common.o: msed/Device_common.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -s -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/Device_common.o msed/Device_common.cpp

${OBJECTDIR}/msed/DiskList.o: msed/DiskList.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -s -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/DiskList.o msed/DiskList.cpp
