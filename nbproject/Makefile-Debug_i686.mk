...
${OBJECTDIR}/msed/MsedDev.o: msed/MsedDev.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Imsed/linux -Imsed -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/MsedDev.o msed/MsedDev.cpp

${OBJECTDIR}/msed/MsedDevEnterprise.o: msed/MsedDevEnterprise.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Imsed/linux -Imsed -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/MsedDevEnterprise.o msed/MsedDevEnterprise.cpp

${OBJECTDIR}/msed/MsedDevGeneric.o: msed/MsedDevGeneric.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Imsed/linux -Imsed -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/MsedDevGeneric.o msed/MsedDevGeneric.cpp

${OBJECTDIR}/msed/MsedDevOpal.o: msed/MsedDevOpal.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Imsed/linux -Imsed -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/MsedDevOpal.o msed/MsedDevOpal.cpp

${OBJECTDIR}/msed/MsedDevOpal1.o: msed/MsedDevOpal1.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Imsed/linux -Imsed -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/MsedDevOpal1.o msed/MsedDevOpal1.cpp

${OBJECTDIR}/msed/MsedDevOpal2.o: msed/MsedDevOpal2.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Imsed/linux -Imsed -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/MsedDevOpal2.o msed/MsedDevOpal2.cpp
...
${OBJECTDIR}/msed/MsedAnnotatedDump.o: msed/MsedAnnotatedDump.cpp 
	${MKDIR} -p ${OBJECTDIR}/msed
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Imsed/linux -Imsed -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/MsedAnnotatedDump.o msed/MsedAnnotatedDump.cpp
...
${OBJECTDIR}/msed/linux/MsedDevOS.o: msed/linux/MsedDevOS.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -Imsed/linux -Imsed -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msed/linux/MsedDevOS.o msed/linux/MsedDevOS.cpp
